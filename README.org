...
* Build
  ...
  Example: Build a Natty 64bit Box (Warning: Build a Vagrant Box takes
  about 20 minutes on my i7 MacBook Pro - go get some lunch & come
  back)
...
rake box:lucid32
  ...
  Example: Build All Boxes (Warning: Takes a couple hours to build 32
  & 64 bit boxes for Lucid, Maverick & Natty)
