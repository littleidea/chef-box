#+Title:Chef Box: Ubuntu Chef Images for Vagrant
#+AUTHOR:Tim Dysinger
...
join to the Chef cluster.  You can practice your cookbook, search &
knife skills really easily with 3 disposable nodes.  See the examples
below for more info.
